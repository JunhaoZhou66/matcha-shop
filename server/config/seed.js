...
const seedProducts = () => {
  const products = [
    ...
    },
    {
      ...
      category: 'Culinary',
      image_url: 'https://images.unsplash.com/photo-1545518913-88c355ef02cf?w=400&h=400&fit=crop',
      stock: 80,
    ...
    },
    {
      ...
      category: 'Ceremonial',
      image_url: 'https://images.unsplash.com/photo-1558160074-4d7d8bdf4256?w=400&h=400&fit=crop',
      stock: 20,
      origin: 'Uji, Kyoto Prefecture',
      weight: '30g',
      servings: 15,
    ...
    // 抹茶工具套装 (Matcha Tools & Sets)
    {
      ...
      category: 'Sets',
      image_url: 'https://images.unsplash.com/photo-1563822249366-3efb23b8e0c9?w=400&h=400&fit=crop',
      stock: 45,
      origin: 'Japan',
      weight: '150g',
      servings: null,
    ...
    },
    {
      ...
      category: 'Sets',
      image_url: 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?w=400&h=400&fit=crop',
      stock: 60,
      origin: 'Japan',
      weight: '400g',
      servings: 20,
    ...
    // 即饮抹茶产品 (Ready-to-Drink)
    {
      ...
      image_url: 'https://images.unsplash.com/photo-1556881286-fc6915169721?w=400&h=400&fit=crop',
      stock: 70,
      origin: 'Japan',
      weight: '1.5L',
      servings: 6,
    ...
    },
    {
      ...
      category: 'Ready-to-Drink',
      image_url: 'https://images.unsplash.com/photo-1534353473418-4cfa6c56fd38?w=400&h=400&fit=crop',
      stock: 55,
      origin: 'Japan',
      weight: '720ml',
      servings: 12,
    ...
    },
    {
      ...
      category: 'Ready-to-Drink',
      image_url: 'https://images.unsplash.com/photo-1499638673689-79a0b5115d87?w=400&h=400&fit=crop',
      stock: 40,
      origin: 'Japan',
      weight: '1L',
      servings: 4,
    ...
    // 限定版系列 (Limited Edition)
    {
      ...
      image_url: 'https://images.unsplash.com/photo-1522120691812-dcdfb625f397?w=400&h=400&fit=crop',
      stock: 15,
      origin: 'Kyoto Prefecture',
      weight: '30g',
      servings: 15,
    ...
    },
    {
      ...
      category: 'Limited Edition',
      image_url: 'https://images.unsplash.com/photo-1542372147193-a7aca54189cd?w=400&h=400&fit=crop',
      stock: 10,
      origin: 'Uji, Kyoto Prefecture',
      weight: '25g',
      servings: 12,
    ...
    },
    {
      ...
      category: 'Limited Edition',
      image_url: 'https://images.unsplash.com/photo-1548679847-1d4ff48016c7?w=400&h=400&fit=crop',
      stock: 8,
      origin: 'Nishio, Aichi Prefecture',
      weight: '20g',
      servings: 10,
